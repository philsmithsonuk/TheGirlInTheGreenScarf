...
class Ebizmarts_SagePaySuite_Model_Api_Payment extends Mage_Payment_Model_Method_Cc {
    ...
    protected $MD = NULL;
    private $_sharedConf = array('sync_mode', 'email_on_invoice', 'trncurrency', 'referrer_id', 'vendor', 'timeout_message', 'connection_timeout', 'send_basket', 'sagefifty_basket');
    ...
    protected function _setRequestCurrencyAmount($request, $quote)
    {
		...
		if((string)$this->getConfigData('trncurrency') == 'store'){
			...
			$request->setAmount( $this->formatAmount($quote->getGrandTotal(), Mage::app()->getStore()->getCurrentCurrencyCode()) );
